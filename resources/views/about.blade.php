...
<head lang="en">
    ...
    <title>BIOGRAFIA CARLOS LEON</title> 
  ...
  <!--   <div id="arrows">
    ...
    <div class="slide story" id="slide-1" data-slide="1">
        <div class="container">
            <div id="home-row-1" class="row clearfix">
                <div class="col-12">
                    <h1 class="font-semibold">CARLOS LEON <br><span class="font-thin">BIOGRAFIA</span></h1>
                    <h4 class="font-thin">PARTE DE LA HISTORIA <br> <span class="font-semibold">DE MI VIDA<br>
                    <br>
                </div><!-- /col-12 -->
            </div><!-- /row -->
            <div id="home-row-2" class="row clearfix">
                <div class="col-12 col-sm-4"><div class="home-hover navigation-slide" data-slide="4"><img src="images/chico.png"></div><span>Vida Profesional</span></div>
                <div class="col-12 col-sm-4"><div class="home-hover navigation-slide" data-slide="3"><img src="images/hombre.png"></div><span>Educación</span></div>
                <div class="col-12 col-sm-4"><div class="home-hover navigation-slide" data-slide="5"><img src="images/deportes.png"></div><span>Pasatiempos</span></div>
            </div><!-- /row -->
        </div><!-- /container -->
    </div><!-- /slide1 -->
    ...
    <div class="slide story" id="slide-3" data-slide="3"> 
            ...
            <div class="row title-row">
                <div class="col-12 font-thin">ESTUDIOS ACADÉMICOS
                </div>
                <div class="col-10 col-sm-10 font-light">En Primaria desde 1ero. Primaria hasta 6to. Primaria recibí
                </div>
            </div><!-- /row -->
            <!-- /row -->
    ...
    <div class="slide story" id="slide-4" data-slide="4">
        <div class="container">
            <div class="row title-row">
                <div class="col-12 font-thin">DESARROLLADOR <br><span class="font-semibold">Capacitándome día con día</span>
                </div>
            </div><!-- /row -->
            ...
            <div class="row subtitle-row">
                <div class="col-sm-1 hidden-sm">&nbsp;</div>
                <div class="col-12 col-sm-10 font-light">Se puede ser un buen desarrollador sin necesidad de haber un tutor o una persona que le explique, en internet se encuentran documentos muy interesantes y Youtube es una herramienta importante a la hora de reforzar conocimientos.</div>
                <div class="col-sm-1 hidden-sm">&nbsp;</div>
            </div><!-- /row -->
